...
public class BufferedDataTableCreator2 implements RowContainerTableCreator {
    ...
    private RowContainerCustomKey m_rowContainer;
     ...
     */
    public BufferedDataTableCreator2(final TableSpec spec, final ExecutionContext context,
        ...
        // TODO make sure dataTableSpec is actually supported...
        try {
            m_rowContainer = RowContainerFactory.createCustomKey(m_exec, m_dataTableSpec, Collections.emptyMap());
    ...
    public BufferedDataTable getTable() {
        ...
        try {
            ...
            return m_exec.createSpecReplacerTable(table, correctedSpec);
        } catch (IOException ex) {
            throw new IllegalArgumentException("meep");
        }
    }
